...
(function(){
    var tool ,
        handlerbar  = {
            locationCell    : Handlebars.compile( $( "#locationLiCellTemplate" ).html() ) ,
            chooseCell      : Handlebars.compile( $( "#locationChooseCellTemplate" ).html() ) 
        } ,
        dom         = {
    ...
    tool   = {
        getLocationData     : function( cb ){
            $.getJSON( "/assets/location.json" , function( rtn ){
